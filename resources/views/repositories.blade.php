<x-app-layout>
    ...
    <div class="min-h-full" x-data="{mn:false}">
        <nav class="bg-gray-800">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="{{route('repositories')}}" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium" aria-current="page">Repositories</a>
                        ...
                        <div class="ml-4 flex items-center md:ml-6">
                            ...
                            <div class="ml-3 relative" x-data="{menu:false}">
                                ...
                                <div x-show="menu" x-cloak class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                                    ...
                                    <div class="px-4 py-3 bg-gray-300" role="none">
                                        <p class="text-sm" role="none">Signed in as</p>
                                        <p class="text-sm font-medium font-bold text-gray-900 truncate" role="none">{{auth()->user()->name}}</p>
                                    </div>
                                    <div class="py-1" role="none">
                                        <!-- Active: "bg-gray-100 text-gray-900", Not Active: "text-gray-700" -->
                                        <a href="{{route('profile.show')}}" class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">Account settings</a>
            ...
            <div class="md:hidden" id="mobile-menu" x-show="mn" x-cloak>
                <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    ...
                    <a href="{{route('repositories')}}" class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium" aria-current="page">Repositories</a>
        ...
        <header class="bg-white shadow-sm">
            <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
                <h1 class="text-lg leading-6 font-semibold text-gray-900">My repositories</h1>
            </div>
        </header>
        <main>
            <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                ...
                <div class="lg:flex lg:items-center lg:justify-between">
                    <div class="flex-1 min-w-0">
                        <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">A group of repositories</h2>
                    </div>
        ...
        Add
                ...
                <div class="pt-5">
                    <ul role="list" class="mt-3 grid grid-cols-1 gap-5 sm:gap-6 sm:grid-cols-2 lg:grid-cols-4">
                        @forelse(auth()->user()->Repository()->get() as $r)
                        <li class="col-span-1 flex shadow-sm rounded-md">
                            <div class="flex-shrink-0 flex items-center justify-center w-16 bg-pink-600 text-white text-sm font-medium rounded-l-md">
                                ...
                                @case('gitlab')
                                        <img src="https://about.gitlab.com/images/new_logo/A.jpg">
                                        @break
                            ...
                            <div class="flex-1 flex items-center justify-between border-t border-r border-b border-gray-200 bg-white rounded-r-md truncate">
                                <div class="flex-1 px-4 py-2 text-sm truncate">
                                    <a href="{{route('repositories.manage', $r->slug)}}" class="text-gray-900 font-medium hover:text-gray-600">{{$r->name}}</a>
                                    <p class="text-gray-500">Public repository</p>
                                </div>
                            ...
                            <div class="text-center w-full">
                                ...
                                <p class="mt-1 text-sm text-gray-500">Add a repository to this group.</p>
                                <div class="mt-6">
            ...
            <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                ...
                <div class="lg:flex lg:items-center lg:justify-between">
                    <div class="flex-1 min-w-0">
                        <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">Ungrouped repositories</h2>
                    </div>
                    <div class="mt-5 flex lg:mt-0 lg:ml-4">
